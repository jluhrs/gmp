...
public class JmsStatusTranslatorIT extends FelixContainerConfigurationBase {
    ...
    protected String confDir() {
        return "/src/test/resources/conf/status-item-translator/jms";
    }

    @Test
    public void jmsTranslator() throws Exception {
        //register handlers
