...
class EnforceOrderPolicyTest extends FunSuite with MockitoSugar {
  ...
  test("order ordered") {
    ...
    val collectedValues = CollectedValue[Double]("KEY1", 1.0, "comment", 0) ::CollectedValue[Double]("KEY2", 1.0, "comment", 0):: Nil
    val orderedValues = CollectedValue[Double]("KEY1", 1.0, "comment", 0) ::CollectedValue[Double]("KEY2", 1.0, "comment", 0):: Nil
  ...
  test("order unordered") {
    ...
    val ep = new EnforceOrderPolicy(config)
    val collectedValues = CollectedValue[Double]("KEY2", 1.0, "comment", 0) ::CollectedValue[Double]("KEY1", 1.0, "comment", 0):: Nil
    val orderedValues = CollectedValue[Double]("KEY1", 1.0, "comment", 0) ::CollectedValue[Double]("KEY2", 1.0, "comment", 0):: Nil
