...
public class PropertyHolderFactory implements ManagedServiceFactory {
    ...
    public PropertyHolderFactory(BundleContext context, ChannelAccessServer channelFactory) {
