...
public class StatusSetterIT extends FelixContainerConfigurationBase {
    ...
    public void checkSending() throws Exception {
        ...
        StatusSetter setter = (StatusSetter) context.getService(context.getServiceReference("edu.gemini.aspen.giapi.status.setter.IStatusSetter"));
        ...
        setter.setStatusItem(new BasicStatus<String>("gpi:status1", "bla"));
