 ...
 */
public class AsymptoticWithNoiseSimulatedStatus extends BaseSimulatedStatus<Double> {
    ...
    public AsymptoticWithNoiseSimulatedStatus(String name, int updateRate, double min, double max, double period, double noiseAmplitude) {
