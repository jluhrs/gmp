 ...
 * will contain a sequence command and dispatch them to the clients via JMS
 */

public class JMSSequenceCommandProducer implements ExceptionListener {

    private final Logger LOG = Logger.getLogger(
            JMSSequenceCommandProducer.class.getName());
    ...
    /**
     * This method takes the given action and converts it into a JMS message to
    ...
    public HandlerResponse dispatchAction(Action action) {
        ...
        try {
            ...
            //send the message
            Destination topic = _session.createTopic(
                    TOPIC_MAP.get(action.getSequenceCommand()));
